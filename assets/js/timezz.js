  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(TimezZ, [{
    ...
    value: function initTimer() {
      ...
      if (typeof this.settings.finished === 'function' && !canContinue) {
        ...
        if(countHours=='00'){
            this.element.innerHTML = this.outputTemplate(canContinue ? countMinutes : 0, 'minutes') + this.outputTemplate(canContinue ? countSeconds : 0, 'seconds');
        }else{
            this.element.innerHTML = this.outputTemplate(canContinue ? countHours : 0, 'hours') + this.outputTemplate(canContinue ? countMinutes : 0, 'minutes') + this.outputTemplate(canContinue ? countSeconds : 0, 'seconds');
        }
